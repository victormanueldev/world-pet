...
This spec defines the centralized route configuration system that enables role-based routing with auto-generated navigation for the multi-tenant application.
