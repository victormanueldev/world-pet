...
This skill is used to generate high-quality, comprehensive frontend tests for the project following established conventions and best practices.
...
- Uses `npm analyze-component` output as context
...
npm analyze-component <path>

# Review existing test
npm analyze-component <path> --review
```
